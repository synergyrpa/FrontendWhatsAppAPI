...
export default function Reports() {
  ...
  const prepararDadosGrafico = () => {
    ...
    relatorios.forEach((item) => {
      const data = new Date(item.date_time_send).toLocaleDateString();
    ...
    return {
      options: {
        ...
        xaxis: { categories: Object.keys(agrupado) },
      ...
      <div className="flex-1 p-10">
        ...
        {!loading && relatorios.length > 0 && (
          <div className="mt-10 bg-white p-6 rounded shadow">
            ...
            <div className="overflow-y-auto max-h-[500px] rounded border">
